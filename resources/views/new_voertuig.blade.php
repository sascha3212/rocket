                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" action="{{url('/new_voertuig')}}">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <label for="voertuigtype_voertuigtype_id" class="col-md-4 control-label">Voertuig</label>

                                    <div class="col-md-6">
                                        <select class="form-control" id="voertuigtype_voertuigtype_id" name="voertuigtype_voertuigtype_id">
